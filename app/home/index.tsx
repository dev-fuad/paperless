...
const DUMMY_ACCOUNTS = [
  ...
  { id: 'acc_2', name: 'Account 2', openingBalance: 1000000, closingBalance: 850000 },
  { id: 'acc_3', name: 'Account 3', openingBalance: 50000, closingBalance: 90000 },
];
  ...
  return (
    <SafeAreaView>
      <Appbar.Header>
        ...
        <Appbar.Action icon="arrow-top-right" mode="contained" onPress={() => { }} />
      ...
      <View style={styles.cards}>
        {DUMMY_ACCOUNTS.map((account) => <AccountCard key={account.id} account={account} />)}
      </View>

      <Card mode="contained">
        <Card.Title title="Transactions" right={() => <Button>View All</Button>} />
        <Card.Content>
